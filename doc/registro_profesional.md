...
![Alt text](img/Pasted%20Graphic%203.png)
_Imagen de referencia del formulario: Datos de registro_
...
### Datos del paciente
![Alt text](img/Pasted%20image%2020230214153326.png)
_Imagen de referencia del formulario: Datos del paciente_
...
![Alt text](img/datos_de_muestra.png)
_Imagen de referencia del formulario: Datos de muestra_
...
![[Pasted image 20230214153430.png]][label](img)
_Imagen de referencia del formulario: Botones de envio de muestra al laboratorio_
